...
<div class="member-grade-box">
	...
	<div class="right-box">
		<div class="shopping-info point">
			<div class="info-item">
				<span class="info-title"><img class="icon-cart">장바구니</span> <span
					class="info-data"> <a href="cart_view.jsp"><%=cart_item_count%>
						<span class="unit">개</span></a></span>
			</div>
			<div class="info-item">
				<span class="info-title"><img class="icon-order">구매목록</span> <span
		...
		<div class="shopping-info">
			...
			<div class="info-item">
				<span class="info-title"><img class="icon-reply"></i>상품댓글</span> <span
