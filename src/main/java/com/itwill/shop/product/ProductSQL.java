...
public class ProductSQL {
	...
	public final static String PRODUCT_SELECT_BY_CATEGORY_DESC_CLICK = "select * from product where category_no=? order by p_click_count asc";
	
	public final static String PRODUCT_COMMENT_INSERT = "INSERT INTO product_comment (pc_no,pc_content,pc_regedate,pc_mark,p_no, writer) "
			+ "VALUES (product_comment_pc_no_sequence.nextval,?, sysdate, ?,?,?)";
	...
	public final static String PRODUCT_COMMENT_SELECT_BY_USERID = "SELECT pc_no, pc_content, pc_regdate, pc_mark, p_no,writer"
			+ " FROM product_comment WHERE user_id = ?";	
}
