...
public class OrderSQL {
	public static final String ORDERS_INSERT= 
										"insert into orders(o_no, o_desc, o_date, o_price, user_id,d_no) values(orders_o_no_SEQ.nextval, ?, sysdate, ?, ?,?)";
	...
	public static final String ORDERS_SELECTE_WITH_D_NO=
										"select * from orders o join delivery d on o.d_no = d.d_no where o.o_no = ?";
